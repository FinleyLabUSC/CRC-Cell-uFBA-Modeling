...
folder_path_lst = {[folder_path_prefix 'WT_vs_KRAS_CRC_media/'], [folder_path_prefix 'WT_vs_KRAS_CAF_media/'], ...
    [folder_path_prefix 'WT_CRC_media_vs_CAF_media/'], [folder_path_prefix 'KRAS_CRC_media_vs_CAF_media/']};  % create these four directories before running the codes below
...
for i=1:4
    ...
    upFBA_model(init_value_data, fold_change_kras_data, ...
